...
public class PolygonServiceUnitTest {

	
	@TestConfiguration
	static class PolygonServiceTestContextConfiguration {
	...
	@Test
	public void succesfullyGetPolygenTest() throws PolygonException {
		String vin = "2G1WM16N26J58041U";
		String polygonId = "58a58bf685979b5415f3a398";
		Polygon polygon = polygonService.getPolygen(vin);
		assertThat(polygon.getPolygonId()).isEqualTo(polygonId);
		assertThat(polygon.getVin()).isEqualTo(vin);
	}
